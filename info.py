...
PICS = (environ.get('PICS', 'https://telegra.ph/file/a41bd7562e98b267d601e.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+YLFPohk9DQQ3YTE1')
...
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "Flase"), False)
...
MULTI_CLIENT = False
name = str(environ.get('name', 'auto-filter-stream'))
...
if HAS_SSL:
    URL = "https://auto-forward-stream-26ea9e346ebf.herokuapp.com/".format(FQDN)
else:
    URL = "https://auto-forward-stream-26ea9e346ebf.herokuapp.com/".format(FQDN)
